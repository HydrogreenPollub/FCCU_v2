...
float adc_3v3_coeffs[ADC_3V3_VOLTAGE_COEFF_COUNT] = { 3.3500774500908527e-002, 7.7284457423388154e-004,
    9.6076736543219649e-008, -8.2413978954965527e-011, 2.7618434159931806e-014, -3.3339453919978806e-018 };
...
void adc_on_loop()
{
    ...
    //   Wszystko
    ESP_LOGI("ADC", "FC: %3.1f    SC:  %3.1f     USB: %2.1f    4.: %2.1f   T: %2.1f", V_FC_value, V_SC_value,
        V_USB_value, P_value, T_value); // To calibrate
